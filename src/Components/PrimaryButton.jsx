...
const PrimaryButton = ({ btntext, onClick }) => {
  return (
    <button
      className="w-full h-12 bg-blue-800 px-6 py-3 text-white text-lg font-bold relative overflow-hidden z-30 group hover:bg-sky-800 transition-all duration-500 rounded tracking-wider"
      onClick={onClick}
    >
      {btntext}
      <svg
        className="absolute inset-0 left-0 top-0 fill-blue-400 -z-30 opacity-0 group-hover:opacity-100 group-hover:duration-300 group-hover:transition-all group-active:fill-sky-950"
